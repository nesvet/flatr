...
mv "${temporaryDirectory}/fln" "${installDirectory}/fln"
chmod +x "${installDirectory}/fln"

echo "Installed fln to ${installDirectory}/fln"

if command -v fln >/dev/null 2>&1; then
	echo "Run: fln --help"
else
	echo "Add ${installDirectory} to your PATH to use fln."
fi
